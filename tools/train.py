...
from openselfsup.apis import train_model
from openselfsup.datasets import build_dataset
from openselfsup.models import build_model
from openselfsup.utils import collect_env, get_root_logger, traverse_replace, set_random_seed
...
def parse_args():
    ...
    parser.add_argument(
        '--load_from', help='only load model checkpoint')
    parser.add_argument(
...
def main():
    ...
    if args.launcher == 'none':
        ...
        assert cfg.model.type not in \
            ['DeepCluster', 'MOCO', 'SimCLR', 'ODC', 'NPID', 'UPDETR'], \
