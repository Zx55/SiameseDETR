...
class VanillaTR(nn.Module):
    ...
    def __init__(self,
        ...
        decoder_layer = VanillaDecoderLayer(hidden_dim, nhead, dim_feedforward,
                                            dropout, activation, normalize_before)
        decoder_norm = nn.LayerNorm(hidden_dim)
        self.decoder = VanillaDecoder(decoder_layer, num_decoder_layers, decoder_norm,
    ...
    def forward(self, src, mask, query_embed, pos_embed, decoder_mask=None):
        ...
        return hs, memory.permute(1, 2, 0).view(bs, c, h, w), None
