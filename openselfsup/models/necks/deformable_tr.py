...
class DeformableTR(nn.Module):
    ...
    def forward(self, srcs, masks, query_embed, pos_embeds, decoder_mask=None):
        ...
        if self.two_stage:
            ...
            query_embed = query_embed[:, 0]  # add by gs
            query_embed, tgt = query_embed, self.tgt_embed.weight # tgt_embed by gs
        ...
        hs, inter_references = self.decoder(tgt, reference_points, memory,
                                            spatial_shapes, level_start_index, valid_ratios, query_embed, mask_flatten,  tgt_mask=decoder_mask)
        ...
        return hs, multi_scale_memorys, (init_reference_out, inter_references_out)
